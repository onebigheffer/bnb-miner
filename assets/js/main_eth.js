...
function approve() {
    ...
    approveWBNB(web3.utils.toWei(trxspenddoc.value));
}
...
function refreshData(){
    ...
    contractBalance(function(result){
        ...
        balanceElem.textContent = Number(result).toFixed(7).toLocaleString() + ' WBNB';
    ...
    userBalance(function(result){
        ...
        userBalanceElem.textContent = Number(result).toFixed(7).toLocaleString() + ' WBNB';
    });
